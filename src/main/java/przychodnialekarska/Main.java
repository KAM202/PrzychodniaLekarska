...
public class Main extends Application {
    ...
    //TODO zmienic pozniej te rzeczy na -1 albo puste
    public static String imie, nazwisko;

    @Override
    public void start(Stage primaryStage) throws Exception{
        test();
        //System.out.println(getClass().getResource("/fxml/LoginForm.fxml"));
        //System.out.println(getClass().getResource("/przychodnia.db"));
